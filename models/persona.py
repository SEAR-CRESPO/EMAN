class persona:
    def __init__(self, PER_ID, PER_UUID, PER_CONTRASENA, PER_NUMERO_DOCUMENTO, PER_PRIMER_NOMBRE, PER_SEGUNDO_NOMBRE, PER_PRIMER_APELLIDO, PER_SEGUNDO_APELLIDO,):
        self.PER_ID                   = PER_ID
        self.PER_UUID                 = PER_UUID
        self.PER_CONTRASENA           = PER_CONTRASENA
